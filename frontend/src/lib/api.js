...
export const fastapi = async (operation, url, params, success_callback, failure_callback) => {
    ...
    let options = {
        method: method,
        headers: {
            "Content-Type": content_type // header 중에서 Content-Type 는 요청의 본문에 포함된 데이터의 유형을 나타낸다. 주로 post, put 요청과 함게 사용되며, application/json, application/x-www-form-urlencoded 등의 값을 가질 수 있습니다. 
        }
